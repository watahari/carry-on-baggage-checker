const translations = {
    ja: {
        ...
        'description': 'スーツケースのサイズを入力すると、どの航空会社で手荷物として持ち込めるかを確認できます。',
        ...
        'disclaimer': '※ 各航空会社の規定は変更される可能性があります。実際の搭乗前に各航空会社の最新情報をご確認ください。',
        'suitcase-size': 'スーツケースサイズ: {width} × {height} × {depth} cm',
        'suitcase-weight': '重量: {weight} kg',
        'total-length': '3辺合計: {length} cm',
        'no-compatible': '申し訳ございません。入力されたサイズでは持ち込み可能な航空会社が見つかりませんでした。',
        'domestic': '国内線',
        'international': '国際線',
    ...
    en: {
        ...
        'description': 'Enter your suitcase dimensions to check which airlines allow it as carry-on baggage.',
        ...
        'disclaimer': '* Airline regulations may change. Please check the latest information from each airline before your actual flight.',
        'suitcase-size': 'Suitcase size: {width} × {height} × {depth} cm',
        'suitcase-weight': 'Weight: {weight} kg',
        'total-length': 'Total dimensions: {length} cm',
        'no-compatible': 'Sorry, no airlines were found that allow carry-on for the entered dimensions.',
        'domestic': 'Domestic',
